...
@section('content')
    <main class="content"style="margin-top: -65px; margin-left: -40px" >
        <div class="container-fluid p-0">
            ...
            <div class="mb-3">
                <h1 class="h3 d-inline align-middle">Chỉnh sửa <strong>Thể loại sách</strong></h1>
            </div>
            <div class="row">
                        ...
                        <form action="{{route('category.update', $category->id)}}" method="post">
                            ...
                            <div class="card-body">
                                <div class="input-data" style="margin-bottom: 15px">
                                    ...
                                    <input type="text" name="name" value="{{$category->name ?? ''}}" class="form-control" placeholder="Tên">
                                </div>
                                <div class="input-data mb-5" style="margin-bottom: 15px">
                                    <label for="input" style="margin-bottom: 5px">Mô tả:</label>
                                    <input type="text" name="description" value="{{$category->description ?? ''}}" class="form-control" placeholder="Mô tả">
                                </div>
