...
@section('content')
    <main class="content"style="margin-top: -65px; margin-left: -40px" >
        <div class="container-fluid p-0">
            ...
            <div class="mb-3">
                <h1 class="h3 d-inline align-middle">Chỉnh sửa <strong>Sách</strong></h1>
            </div>
            <div class="row">
                        ...
                        <form action="{{route('book.edit', $book->id)}}" method="post">
                            ...
                            <div class="card-body">
                                <div class="input-data" style="margin-bottom: 15px">
                                    ...
                                    <input type="text" name="name" value="{{$book->name ?? ''}}" class="form-control" placeholder="Tên">
                                </div>
                                <div class="input-data" style="margin-bottom: 15px">
                                    <label for="input" style="margin-bottom: 5px">Mô tả:</label>
                                    <textarea name="description"  class="form-control" placeholder="Mô tả" rows="10">{{$book->description ?? ''}}</textarea>
                                </div>
                                <div class="input-data" style="margin-bottom: 15px">
                                ...
                                <div class="input-data" style="margin-bottom: 15px">
                                    ...
                                    <input type="number" name="amount" value="{{$book->amount ?? ''}}" class="form-control" placeholder="Số lượng">
                                </div>
                                <div class="input-data" style="margin-bottom: 15px">
                                    <label for="input" style="margin-bottom: 5px">Giá cho thuê:</label>
                                    <input type="number" name="rental_price" value="{{$book->rental_price ?? ''}}" class="form-control" placeholder="Giá cho thuê">
                                </div>
                                <div class="input-data" style="margin-bottom: 15px">
                                    <label for="input" style="margin-bottom: 5px">Giá bán:</label>
                                    <input type="number" name="purchase_price" value="{{$book->purchase_price ?? ''}}" class="form-control" placeholder="Giá bán">
                                </div>
